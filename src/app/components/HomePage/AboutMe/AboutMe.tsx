...
import { Card, Cell, Container, GridX, Section, Typography } from "fj-elements";
          ...
          <Cell small={12} large={4}>
            <Card variant="cyan">
              <Card.Header>
                <Typography
                  as="p"
                  style={{ color: "cyan", textAlign: "center" }}
                >
                  Key Facts
                </Typography>
              </Card.Header>
            ...
            <Card variant="pink">
              ...
              <Card.Body>
                <div className={styles.educationLayout}>
                  {degrees.length > 0 && (
                    <div>
                      <Typography as="h4" className={styles.educationHeading}>
                        Education
                      </Typography>
